const id = "t845.md";
						...
						const slug = "t845";
						const body = "";
						const data = {title:"SF-TB T845",description:"Machine Screws",main:{id:1,content:"Introducing the SF-TB T845 – your go-to solution for precision fastening in machinery and equipment. This comprehensive set of machine screws is meticulously crafted to meet the stringent demands of industrial applications, ensuring secure and reliable fastening.\n",imgCard:
						new Proxy({"src":"/_astro/product-image-1.Dqz5fi0L.avif","width":1458,"height":1042,"format":"avif","fsPath":"C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/images/product-image-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/images/product-image-1.avif";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/images/product-image-1.avif");
							return target[name];
						}
					})
					,imgMain:
						new Proxy({"src":"/_astro/product-image-main-1.DocbQbk7.avif","width":1764,"height":1080,"format":"avif","fsPath":"C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/images/product-image-main-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/images/product-image-main-1.avif";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/images/product-image-main-1.avif");
							return target[name];
						}
					})
					...
					,second:
						...
						const _internal = {
							type: 'content',
							filePath: "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/content/products/t845.md",
							rawData: undefined,
						};
