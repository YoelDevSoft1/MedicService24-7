const id = "ja/guides/intro.mdx";
						const collection = "docs";
						const slug = "ja/guides/intro";
						...
						const data = {title:"はじめに",description:"ScrewFastの包括的なドキュメントを探索して、プレミアムツールと建設サービスを詳しく見てください。",editUrl:true,head:[],template:"doc",sidebar:{order:2,label:"Introduction to Services",hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/content/docs/ja/guides/intro.mdx",
							rawData: undefined,
						};
