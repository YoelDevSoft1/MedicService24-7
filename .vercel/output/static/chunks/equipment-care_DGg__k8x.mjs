const id = "tools/equipment-care.mdx";
						const collection = "docs";
						const slug = "tools/equipment-care";
						...
						const data = {title:"Equipment Care & Maintenance",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:2,label:"Equipment Care",hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/content/docs/tools/equipment-care.mdx",
							rawData: undefined,
						};
