const id = "tools/tool-guides.mdx";
						const collection = "docs";
						const slug = "tools/tool-guides";
						...
						const data = {title:"Tool Guides",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Tool Guides",hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/content/docs/tools/tool-guides.mdx",
							rawData: undefined,
						};
