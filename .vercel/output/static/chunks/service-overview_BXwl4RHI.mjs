const id = "construction/service-overview.mdx";
						const collection = "docs";
						const slug = "construction/service-overview";
						...
						const data = {title:"Comprehensive Service Overview",description:"Explore ScrewFast's comprehensive documentation for an in-depth look at our premium tools and construction services.",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Service Overview",hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/content/docs/construction/service-overview.mdx",
							rawData: undefined,
						};
