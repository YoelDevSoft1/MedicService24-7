const id = "zh-cn/guides/getting-started.mdx";
						const collection = "docs";
						const slug = "zh-cn/guides/getting-started";
						...
						const data = {title:"入门指南",description:"探索 ScrewFast 的全面文档，深入了解我们的优质工具和建筑服务。",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Getting Started",hidden:false,attrs:{}},pagefind:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/salud/OneDrive/Documents/GitHub/MedicService24-7/src/content/docs/zh-cn/guides/getting-started.mdx",
							rawData: undefined,
						};
